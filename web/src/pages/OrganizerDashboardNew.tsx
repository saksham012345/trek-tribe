      ...
      <div className="min-h-screen bg-gradient-to-br from-forest-50 via-nature-50 to-forest-100 p-4 md:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto space-y-6">
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <div className="h-6 w-64 bg-forest-100 rounded" />
            <div className="mt-2 h-4 w-96 bg-forest-50 rounded" />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="bg-white rounded-xl shadow-md p-6">
                <div className="h-12 w-12 bg-forest-100 rounded-lg" />
                <div className="mt-3 h-8 w-24 bg-forest-50 rounded" />
                <div className="mt-2 h-4 w-40 bg-forest-50 rounded" />
              </div>
            ))}
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {Array.from({ length: 2 }).map((_, i) => (
              <div key={i} className="bg-white rounded-xl shadow-md p-6">
                <div className="h-5 w-32 bg-forest-50 rounded" />
                <div className="mt-3 h-24 w-full bg-forest-50 rounded" />
              </div>
            ))}
          </div>
        </div>
