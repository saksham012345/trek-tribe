        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-forest-800 mb-6">
              ...
              <span className="text-forest-700"> Organizers</span>
            </h2>
            <p className="text-xl text-forest-600 max-w-3xl mx-auto leading-relaxed">
              Connect with experienced adventure guides and organizers who have led thousands of successful expeditions
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 bg-gradient-to-br from-forest-500 to-blue-500 rounded-full flex items-center justify-center mr-4">
                  <span className="text-2xl text-white">🏔️</span>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-forest-800">Mountain Masters</h3>
                  <p className="text-forest-600">Himalayan Experts</p>
                  <div className="flex items-center mt-1">
                    <span className="text-yellow-500">⭐⭐⭐⭐⭐</span>
                    <span className="text-sm text-forest-600 ml-2">(500+ expeditions)</span>
                  </div>
                </div>
              </div>
              <p className="text-forest-600 mb-4">
                Led by certified mountaineers with 15+ years of experience in the Himalayas. Specializing in high-altitude treks and peak climbing expeditions.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-forest-100 text-forest-700 rounded-full text-sm">Everest Base Camp</span>
                <span className="px-3 py-1 bg-forest-100 text-forest-700 rounded-full text-sm">Annapurna Circuit</span>
                <span className="px-3 py-1 bg-forest-100 text-forest-700 rounded-full text-sm">Chadar Trek</span>
              </div>
            </div>

            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="flex items-center mb-6">
                <div className="w-16 h-16 bg-gradient-to-br from-nature-500 to-green-500 rounded-full flex items-center justify-center mr-4">
                  <span className="text-2xl text-white">🌲</span>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-forest-800">Wildlife Wonders</h3>
                  <p className="text-forest-600">Safari Specialists</p>
                  <div className="flex items-center mt-1">
                    <span className="text-yellow-500">⭐⭐⭐⭐⭐</span>
                    <span className="text-sm text-forest-600 ml-2">(300+ safaris)</span>
                  </div>
                </div>
              </div>
              <p className="text-forest-600 mb-4">
                Expert naturalists and wildlife photographers with deep knowledge of Indian wildlife. Creating unforgettable safari experiences across national parks.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-nature-100 text-nature-700 rounded-full text-sm">Ranthambore</span>
                <span className="px-3 py-1 bg-nature-100 text-nature-700 rounded-full text-sm">Jim Corbett</span>
                <span className="px-3 py-1 bg-nature-100 text-nature-700 rounded-full text-sm">Bandhavgarh</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold text-forest-800">Adventure Adrenaline</h3>
                  <p className="text-forest-600">Extreme Sports</p>
                  <div className="flex items-center mt-1">
                    <span className="text-yellow-500">⭐⭐⭐⭐⭐</span>
                    <span className="text-sm text-forest-600 ml-2">(200+ adventures)</span>
                  </div>
                </div>
              </div>
              <p className="text-forest-600 mb-4">
                Certified adventure sports instructors specializing in white-water rafting, paragliding, and rock climbing across India's most thrilling locations.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm">Rafting</span>
                <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm">Paragliding</span>
                <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm">Rock Climbing</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-forest-800 mb-6">
              Legendary 
              <span className="text-blue-600"> Adventures</span>
              <span className="text-forest-700"> That Inspire</span>
            </h2>
            <p className="text-xl text-forest-600 max-w-3xl mx-auto leading-relaxed">
              Discover the most sought-after destinations and experiences that have captivated adventurers for generations
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="relative h-64 bg-gradient-to-br from-forest-400 to-blue-500 flex items-center justify-center">
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold text-forest-800 mb-2">Everest Base Camp Trek</h3>
                <p className="text-forest-600 mb-4">The ultimate Himalayan adventure that takes you to the base of the world's highest mountain.</p>
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    <span className="text-yellow-500 text-lg">⭐⭐⭐⭐⭐</span>
                    <span className="text-forest-600 ml-2 text-sm">(2,500+ completed)</span>
                  </div>
                  <span className="text-2xl font-bold text-blue-600">₹45,000</span>
                </div>
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="px-3 py-1 bg-forest-100 text-forest-700 rounded-full text-sm">16 Days</span>
                  <span className="px-3 py-1 bg-forest-100 text-forest-700 rounded-full text-sm">High Altitude</span>
                  <span className="px-3 py-1 bg-forest-100 text-forest-700 rounded-full text-sm">Advanced</span>
                </div>
                <button className="w-full bg-gradient-to-r from-forest-600 to-blue-600 hover:from-forest-700 hover:to-blue-700 text-white py-3 rounded-xl font-semibold transition-all duration-300">
                  Join This Legend 🌟
                </button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="relative h-64 bg-gradient-to-br from-nature-400 to-green-500 flex items-center justify-center">
                <span className="text-8xl text-white">🌲</span>
                <div className="absolute top-4 right-4 bg-white/20 backdrop-blur-sm rounded-full px-3 py-1">
                  <span className="text-white text-sm font-semibold">Wildlife</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-2xl font-bold text-forest-800 mb-2">Ranthambore Tiger Safari</h3>
                <p className="text-forest-600 mb-4">Experience the thrill of spotting the majestic Bengal tiger in its natural habitat.</p>
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    <span className="text-yellow-500 text-lg">⭐⭐⭐⭐⭐</span>
                    <span className="text-forest-600 ml-2 text-sm">(1,800+ completed)</span>
                  </div>
                  <span className="text-2xl font-bold text-blue-600">₹12,000</span>
                </div>
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="px-3 py-1 bg-nature-100 text-nature-700 rounded-full text-sm">3 Days</span>
                  <span className="px-3 py-1 bg-nature-100 text-nature-700 rounded-full text-sm">Wildlife</span>
                  <span className="px-3 py-1 bg-nature-100 text-nature-700 rounded-full text-sm">Beginner</span>
                </div>
                <button className="w-full bg-gradient-to-r from-nature-600 to-green-600 hover:from-nature-700 hover:to-green-700 text-white py-3 rounded-xl font-semibold transition-all duration-300">
                  Spot Tigers 🐅
                </button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <div className="relative h-64 bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center">
                <span className="text-8xl text-white">🏄</span>
                <div className="absolute top-4 right-4 bg-white/20 backdrop-blur-sm rounded-full px-3 py-1">
                  <span className="text-white text-sm font-semibold">Adrenaline</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="text-2xl font-bold text-forest-800 mb-2">Goa Beach Adventure</h3>
                <p className="text-forest-600 mb-4">Water sports, beach camping, and coastal exploration in India's party capital.</p>
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center">
                    <span className="text-yellow-500 text-lg">⭐⭐⭐⭐⭐</span>
                    <span className="text-forest-600 ml-2 text-sm">(3,200+ completed)</span>
                  </div>
                  <span className="text-2xl font-bold text-blue-600">₹8,500</span>
                </div>
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm">4 Days</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm">Water Sports</span>
                  <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm">Beginner</span>
                </div>
